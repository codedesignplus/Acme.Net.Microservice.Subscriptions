...
builder.Services.AddMongo<Acme.Net.Microservice.Subscriptions.Infrastructure.Startup>(builder.Configuration);
builder.Services.AddObservability(builder.Configuration, builder.Environment);
builder.Services.AddLogger(builder.Configuration);
builder.Services.AddRabbitMQ<Acme.Net.Microservice.Subscriptions.Domain.Startup>(builder.Configuration);
builder.Services.AddMapster();
builder.Services.AddFluentValidation();
builder.Services.AddMediatR<Acme.Net.Microservice.Subscriptions.Application.Startup>();
